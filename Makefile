...
PACKAGE := pyfortified-dateutil
PACKAGE_PREFIX := pyfortified_dateutil
...
run-examples:
	...
	@echo "======================================================"
	$(PYTHON3) examples/examples_pyfortified_dateutil.py
	@echo "======================================================"
	$(PYTHON3) examples/example_date_range_list.py
	@echo "======================================================"
	$(PYTHON3) examples/example_date_range_generator.py
	@echo "======================================================"
